...
class Parser {
     ...
     *             if variable already exist in set
     */
    private static void create(Symbol varname) throws CompilationException {
        ...
        if (!added)
            throw new CompilationException(
                    "Already declared " + varname.getValue() + " (line " + varname.getLine() + ", column " + varname.getColumn() + ")");
    }
    ...
    private static boolean check(Symbol varname) throws CompilationException {
        ...
        if (!variables.contains(privateName)) {
            throw new CompilationException(
                    "Undeclared " + varname.getValue() + " (line " + varname.getLine() + ", column " + varname.getColumn() + ")");
        }
        return true;
    }
